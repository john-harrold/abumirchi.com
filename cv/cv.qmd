...
* Web:         [https://ubiquity.tools](https://ubiquity.tools)
* Publication: [https://doi.org/10.1007/s10928-014-9352-6](https://doi.org/10.1007/s10928-014-9352-6)
* GitHub:      [https://github.com/john-harrold/ubiquity-pkpd](https://github.com/john-harrold/ubiquity-pkpd)
...
* Web:         [https://r.ubiquity.tools](https://r.ubiquity.tools)
* CRAN:        [https://CRAN.R-project.org/package=ubiquity](https://CRAN.R-project.org/package=ubiquity)
* GitHub:      [https://github.com/john-harrold/ubiquity](https://github.com/john-harrold/ubiquity)
...
* Web:          [https://onbrand.ubiquity.tools](https://onbrand.ubiquity.tools)
* CRAN:         [https://CRAN.R-project.org/package=onbrand](https://CRAN.R-project.org/package=onbrand)
* GitHub:       [https://github.com/john-harrold/onbrand](https://github.com/john-harrold/onbrand)
 ...
 * Web:          [https://nlmixr2.github.io/nlmixr2rpt/](https://nlmixr2.github.io/nlmixr2rpt/)
 * CRAN:         [https://CRAN.R-project.org/package=nlmixr2rpt](https://CRAN.R-project.org/package=nlmixr2rpt)
 * GitHub:       [https://github.com/john-harrold/nlmixr2rpt](https://github.com/john-harrold/nlmixr2rpt)

 Maintain the `{ruminate}` R package, A pharmacometrics data transformation and analysis tool (2022-present).

* Web:          [https://ruminate.ubiquity.tools](https://ruminate.ubiquity.tools)
* GitHub:       [https://github.com/john-harrold/ruminate](https://github.com/john-harrold/ruminate)

 Maintain the `{formods}` R package, Set of Shiny modules for general tasks (2022-present). 

* Web:          [https://formods.ubiquity.tools](https://formods.ubiquity.tools)
* GitHub:       [https://github.com/john-harrold/formods](https://github.com/john-harrold/formods)


Member of the `{nlmixr2}` development team.

* Web:          [https://nlmixr2.org                       ](https://nlmixr2.org)
* CRAN:         [https://CRAN.R-project.org/package=nlmixr2](https://CRAN.R-project.org/package=nlmixr2)
* GitHub:       [https://github.com/nlmixr2/nlmixr2        ](https://github.com/nlmixr2/nlmixr2)
